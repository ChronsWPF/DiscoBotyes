...
client.on("guildMemberAdd", async member => {
  ...
  let chx = db.get(`welchannel_${message.channel.id}`, channel.id);
  ...
  if (chx === null) {
   ...
   let data = await canva.welcome(member, { link: 
              "https://Your.mywaifu.tech/418acb9.png" })
    ...
    const attachment = new discord.MessageAttachment(
      ...
      "welcome-image.png"
                  ...
                  const chatid = '816744297009381426'
	const channel = member.guild.channels.cache.get(chatid)
  channel.send("Welcome to our Server " + member.user.username, attachment);
...
client.on("ready", () => {
    client.user.setActivity(`~help | The Community - ${client.guilds.cache.size}`, { type: "WATCHING"})
})
